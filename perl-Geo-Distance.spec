...
Source0  : https://cpan.metacpan.org/authors/id/B/BL/BLUEFEET/Geo-Distance-0.23.tar.gz
...
%prep
%setup -q -n Geo-Distance-0.23
cd ..
%setup -q -T -D -n Geo-Distance-0.23 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Geo-Distance-0.23/deblicense/
